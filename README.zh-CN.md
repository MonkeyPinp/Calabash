...
[在线 Demo](https://guesswhat-studio.github.io/Calabash/) · [反馈问题](https://github.com/Guesswhat-Studio/Calabash/issues/new/choose) · 版本 `0.5.7`
...
- **桌面导出热修**：`v0.5.7` 修复 Windows/macOS/Linux 桌面版通过系统保存对话框导出 PNG/PDF 看板图片时的二进制写入权限问题。
