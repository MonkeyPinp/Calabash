...
- **ボード安定性・時間レイヤー・インパクト**: `v0.5.4` は Help をクリックで開く方式にし、Auto-layout の undo/redo、時間レイヤーと『七回死んだ男』ループ demo、タブレット向けレイヤーサムネイル、スマホ Settings のレスポンシブ表示、README のインパクトスナップショットを追加します。
