...
- **Estabilidad, capas temporales e impacto del tablero**: `v0.5.4` hace que Help se abra con clic, permite deshacer/rehacer Auto-layout, añade capas temporales con una demo de bucles de *Siete muertes* y miniaturas de capa para tablet, mejora Settings en teléfono y añade el Impact Snapshot al README.
