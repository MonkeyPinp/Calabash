...
[ライブ demo](https://guesswhat-studio.github.io/Calabash/) · [Issue を報告](https://github.com/Guesswhat-Studio/Calabash/issues/new/choose) · バージョン `0.5.0`
...
- **タブレット対応 web beta**: `v0.5.0` はタッチ操作の改善、有効に機能するボードロック、重複する case 名の混乱防止、より小さな production chunk を追加します。
