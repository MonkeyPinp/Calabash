...
[ライブ demo](https://guesswhat-studio.github.io/Calabash/) · [Issue を報告](https://github.com/Guesswhat-Studio/Calabash/issues/new/choose) · バージョン `0.5.1`
...
- **パズルテンプレート、iPad、CNB パッチ**: `v0.5.1` はミステリーパズル用スターターテンプレートを追加し、iPad Safari の安全領域で下部の章スライダーが隠れないようにし、CNB release デプロイ経路を含めます。
