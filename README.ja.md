...
[ライブ demo](https://guesswhat-studio.github.io/Calabash/) · [Issue を報告](https://github.com/Guesswhat-Studio/Calabash/issues/new/choose) · バージョン `0.4.0`
...
- **デスクトップ安定 beta**: `v0.4.0` は Windows/Linux の未署名バイナリ、macOS の DMG イメージ、ネイティブ JSON インポート/エクスポート、ライブラリ全体のインポート前の安全バックアップ、アプリ内更新チェックを提供します。
