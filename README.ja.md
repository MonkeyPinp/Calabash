...
[ライブ demo](https://guesswhat-studio.github.io/Calabash/) · [Issue を報告](https://github.com/Guesswhat-Studio/Calabash/issues/new/choose) · バージョン `0.3.1`
...
- **デスクトップ beta**: `v0.3.1` は Windows/Linux の未署名バイナリ、macOS の DMG イメージ、アプリ内更新チェックを提供します。
