...
- **Estabilidade, camadas temporais e impacto do quadro**: `v0.5.4` abre Help por clique, permite desfazer/refazer Auto-layout, adiciona camadas temporais com uma demo de loop de *Sete Mortes* e miniaturas de camada para tablet, melhora Settings no telefone e adiciona o Impact Snapshot ao README.
