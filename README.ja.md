...
- **ボード安定性とインパクト**: `v0.5.4` は Help をクリックで開く方式にし、Auto-layout の undo/redo、スマホ Settings のレスポンシブ表示、README のインパクトスナップショットを追加します。
