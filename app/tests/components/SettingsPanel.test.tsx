...
describe('SettingsPanel', () => {
  ...
  it('checks GitHub releases and opens the matching update asset', async () => {
    ...
    vi.stubGlobal('fetch', vi.fn().mockResolvedValue({
      ...
      json: async () => [{
        tag_name: 'v0.5.2',
        html_url: 'https://github.com/Guesswhat-Studio/Calabash/releases/tag/v0.5.2',
        draft: false,
        assets: [
          { name: 'Calabash_0.5.2_windows_x64.exe', browser_download_url: 'https://example.com/calabash.exe' },
        ],
      }],
    }));
    ...
    await waitFor(() => expect(screen.getByText('Download 0.5.2')).toBeInTheDocument());

    fireEvent.click(screen.getByText('Download 0.5.2'));
