...
[在线 Demo](https://guesswhat-studio.github.io/Calabash/) · [反馈问题](https://github.com/Guesswhat-Studio/Calabash/issues/new/choose) · 版本 `0.4.0`
...
- **桌面稳定 beta**：`v0.4.0` 提供未签名 Windows/Linux 二进制和 macOS DMG 镜像，支持系统原生 JSON 导入/导出、完整书库导入前自动安全备份，以及应用内版本检查。
