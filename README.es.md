...
[Demo en vivo](https://guesswhat-studio.github.io/Calabash/) · [Reportar un problema](https://github.com/Guesswhat-Studio/Calabash/issues/new/choose) · Versión `0.5.7`
...
- **Estabilidad, capas temporales, exportación e impacto del tablero**: `v0.5.5` hace que Help se abra con clic, permite deshacer/rehacer Auto-layout, añade capas temporales con una demo de bucles de *Siete muertes* y miniaturas de capa para tablet, exporta tableros como PNG/PDF, mejora Settings en teléfono y añade el Impact Snapshot al README.
- **Pulido de fiabilidad en escritorio**: `v0.5.6` añade `L` para bloquear/desbloquear elementos seleccionados, comprime retratos subidos como JPEG y escribe logs locales de diagnóstico si falla la exportación de imagen del tablero.
- **Hotfix de exportación en escritorio**: `v0.5.7` corrige la exportación PNG/PDF del tablero en escritorio permitiendo escribir archivos binarios desde el diálogo nativo de guardado.
