...
[Demo ao vivo](https://guesswhat-studio.github.io/Calabash/) · [Reportar problema](https://github.com/Guesswhat-Studio/Calabash/issues/new/choose) · Versão `0.5.0`
...
- **Beta web pronta para tablet**: `v0.5.0` melhora a interação por toque, adiciona um bloqueio real do quadro, evita nomes de casos duplicados confusos e divide builds de release em chunks cacheados menores.
