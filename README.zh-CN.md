...
[在线 Demo](https://guesswhat-studio.github.io/Calabash/) · [反馈问题](https://github.com/Guesswhat-Studio/Calabash/issues/new/choose) · 版本 `0.5.0`
...
- **平板就绪 Web beta**：`v0.5.0` 改善触控交互细节，加入真正生效的白板锁，避免令人困惑的重复案件名，并把发布构建拆成更小的缓存分块。
