...
[在线 Demo](https://guesswhat-studio.github.io/Calabash/) · [反馈问题](https://github.com/Guesswhat-Studio/Calabash/issues/new/choose) · 版本 `0.5.1`
...
- **谜题模板、iPad 与 CNB 补丁**：`v0.5.1` 增加每谜/比赛起步模板，让底部章节栏避开 iPad Safari 安全区，并带上 CNB release 部署流程。
